...
public class IteratorChain<E> implements Iterator<E> {
     ...
     */
    private final Queue<Iterator<? extends E>> iteratorsChain = new LinkedList<>();
     ...
     *
     * @param iteratorsChain the array of iterators, not null
     * @throws NullPointerException if iterators array is or contains null
     */
    @SafeVarargs
    public IteratorChain(final Iterator<? extends E>... iteratorsChain) {
        super();
        for (final Iterator<? extends E> element : iteratorsChain) {
            addIterator(element);
        }
    }
     ...
     *
     * @param iteratorsChain the collection of iterators, not null
     * @throws NullPointerException if iterators collection is or contains null
     * @throws ClassCastException   if iterators collection doesn't contain an
     *                              iterator
     */
    public IteratorChain(final Collection<Iterator<? extends E>> iteratorsChain) {
        super();
        for (final Iterator<? extends E> iterator : iteratorsChain) {
            addIterator(iterator);
        }
    }
    ...
    protected void updateCurrentIterator() {
        if (currentIterator == null) {
            if (iteratorsChain.isEmpty()) {
                currentIterator = EmptyIterator.emptyIterator();
            } else {
                currentIterator = iteratorsChain.remove();
            }
        ...
        while (!currentIterator.hasNext() && !iteratorsChain.isEmpty()) {
            currentIterator = iteratorsChain.remove();
        }
    }
